...
Sparqy downloads specimen data from a StarLIMS database using [Polars](https://pola.rs/), [SQLAlchemy](https://www.sqlalchemy.org/), and [PyODBC](https://learn.microsoft.com/en-us/sql/connect/python/pyodbc). Data is stored in local [Parquet files](https://parquet.apache.org/) for further analysis.
